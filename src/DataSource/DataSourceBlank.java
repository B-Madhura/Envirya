...
public class DataSourceBlank extends PropertiesFile

{  
	@Test(dataProvider="SearchProvider20")
	public void verifyDataSourceBlank(String Type , String ProcessName) throws InterruptedException, AWTException
	{
  ...
  @DataProvider(name="SearchProvider20")
   public Object[][] getDataFromDataprovider()
 {
   return new Object[][]
		{
	     
	{"Blank Data Source","Start12"}
