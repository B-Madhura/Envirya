...
public class EnviryaOCR extends PropertiesFile
{
	@Test(dataProvider="SearchProvider21")
	public void verifyEnviryaOCR(String Type , String ProcessName) throws InterruptedException, AWTException
	{
	...
	@DataProvider(name="SearchProvider21")
