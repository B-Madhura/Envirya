...
public class OutputFileNameBlank extends PropertiesFile 

{
	@Test(dataProvider="SearchProvider24")
	public void verifyOutputFileNameBlank(String Type , String ProcessName) throws InterruptedException, AWTException
	{
	   ...
	   Thread.sleep(3000);
        ...
        System.out.println(driver.findElement(By.xpath("//div[contains(text(),'Please enter filename.')]")).getText());
	}
	
	@DataProvider(name="SearchProvider24")
	public Object[][] getDataFromDataprovider()
	{
	return new Object[][]
			{
		     
		{"Output Name Blank","Start11"},
