...
public class QualityCheckersValid extends PropertiesFile
{
	@Test(dataProvider="SearchProvider28")
	public void verifyQualityCheckers(String Type , String ProcessName) throws InterruptedException, AWTException
	{
       ...
       //driver.findElement(By.xpath(p.getProperty("TestFileSubmit"))).click();
        ...
        System.out.println(driver.findElement(By.xpath("//div[contains(text(),'Successfully added qc users')]")).getText());
	    
	}
	
	
	
	@DataProvider(name="SearchProvider28")
