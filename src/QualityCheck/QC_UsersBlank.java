...
public class QC_UsersBlank extends PropertiesFile

{
	@Test(dataProvider="SearchProvider25")
	public void verifyQualityCheckers(String Type , String ProcessName) throws InterruptedException, AWTException
	{
       ...
       //driver.findElement(By.xpath(p.getProperty("TestFileSubmit"))).click();
	    ...
	    System.out.println(driver.findElement(By.xpath("//div[contains(text(),'Please select any user to add')]")).getText());
	    
	}
	
	
	
	@DataProvider(name="SearchProvider25")
