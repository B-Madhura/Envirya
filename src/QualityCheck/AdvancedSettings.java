...
public class AdvancedSettings extends PropertiesFile
{
	@Test(dataProvider="SearchProvider27")
	public void verifyAdvancedSettings(String Type , String ProcessName) throws InterruptedException, AWTException
	{
       ...
       //driver.findElement(By.xpath(p.getProperty("TestFileSubmit"))).click();
	    ...
	    Thread.sleep(3000);
	    driver.findElement(By.xpath(p.getProperty("AdvancedSettings"))).click();
	    Thread.sleep(3000);
	    driver.findElement(By.xpath(p.getProperty("PercentData"))).clear();
	    Thread.sleep(1000);
	    driver.findElement(By.xpath(p.getProperty("PercentData"))).sendKeys("21");
	    Thread.sleep(3000);
        ...
        System.out.println(driver.findElement(By.xpath("//div[contains(text(),'successfully saved')]")).getText());
        
	}
	
	
	
	@DataProvider(name="SearchProvider27")
	public Object[][] getDataFromDataprovider()
	{
	return new Object[][]
			{
		     
		{"Advanced Settings","Start23"},
